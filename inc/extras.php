...
function activello_footer_info() {
	...
	printf( esc_html__( 'Theme by %1$s Powered by %2$s', 'activello' ) , '<a href="http://colorlib.com/" target="_blank" rel="nofollow noopener">Colorlib</a>', '<a href="http://wordpress.org/" target="_blank">WordPress</a>' );
}
